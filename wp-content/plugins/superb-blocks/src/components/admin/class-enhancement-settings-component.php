...
class EnhancementSettingsComponent
{
    ...
    {
?>
        <h4 class="superbaddons-element-text-sm superbaddons-element-text-dark superbaddons-element-text-800 superbaddons-element-m0"><?php echo esc_html__("WordPress Editor Settings", "superb-blocks"); ?></h4>
        <p class="superbaddons-element-text-xs superbaddons-element-text-gray"><?php echo esc_html__("Manage your Superb Addons settings for the WordPress editor.", "superb-blocks"); ?></p>
